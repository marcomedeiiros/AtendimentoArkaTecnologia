...
Corrigir só o estado (usar `AGUARDA_RESPOSTA_DO_CLIENTE`) resolve o defeito mas **não** entrega o que foi pedido: com a conversa em mãos humanas, a citação
...
repeti o erro em outra forma `sessaoAberta.aguardando` como se fosse booleano num arquivo onde a lista certa estava setenta linhas acima.
